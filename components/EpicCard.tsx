  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-[11px] text-slate-400">
        ...
        {epic.fields.duedate && (
          <span className="ml-auto">Due {new Date(epic.fields.duedate).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</span>
        )}
        <span className="ml-auto text-slate-300 font-mono">{epic.key}</span>
      </div>
    </a>
  )
}
